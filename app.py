# app.py - ClaimsSentinel Fraud Detection with SHAP and UI Enhancements
            ...
            if "Fraud Label" not in train_df.columns:
                ...
                if missing:
                    ...
                    if model_choice == "Random Forest":
                        ...
                        st.caption("🔎 These features had the most impact on the fraud prediction model. Use them to inform risk mitigation efforts.")
                    else:
